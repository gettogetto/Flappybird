...
public:
	...
	virtual bool ccTouchBegan(CCTouch* pTouches,CCEvent* pEvent);//ÆÁÄ»´¥Ãþ¿ªÊ¼
	virtual void ccTouchMoved(CCTouch* pTouches,CCEvent* pEvent);//ÆÁÄ»´¥ÃþÒÆ¶¯
	virtual void ccTouchEnded(CCTouch* pTouches,CCEvent* pEvent);//ÆÁÄ»´¥Ãþ½áÊø
